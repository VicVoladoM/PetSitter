...
const crearPetSitter = (req, res) => {
  ...
  let params = req.body;
  conn
    .query(petSitterQueries.crearPetSitter, {
      bind: params,
...
const editarPetSitter = (req, res) => {
  ...
  conn
    .query(petSitterQueries.editarPetSitter, {
...
const obtenerPetSitters = (req, res) => {
  ...
  let params = req.body;
  conn
    .query(petSitterQueries.obtenerPetSitters, {
...
const AgregarPetSitterType = (req, res) => {
  ...
  let params = req.body;
  conn
    .query(petSitterQueries.AgregarPetSitterType, {
      bind: params,
      type: QueryTypes.INSERT,
    })
    .then((result) => {
...
const eliminarPetTypeForPetSitter = (req, res) => {
  const conn = connectBd();
  let id = req.params.id;
  if (id)
    conn
      .query(petSitterQueries.eliminarPetTypeForPetSitter, {
        bind: { id },
        type: QueryTypes.DELETE,
      })
      .then((result) => {
...
const obtenerPetSitterView = (req, res) => {
  const conn = connectBd();
  let params = req.body;
  conn
    .query(petSitterQueries.obtenerPetSitterView, {
      type: QueryTypes.SELECT,
    })
    .then((result) => {
